...
plt.plot(t,fitted1,linestyle="--",zorder=1,label="$N_{MAX}="+str(int(max_infected1))+"\pm"+str(round(error1/max_infected1*100,1))+"\%$")
plt.plot(t,fitted2,linestyle="--",zorder=2,label="$N_{MAX}="+str(int(max_infected2))+"\pm"+str(round(error2/max_infected2*100,1))+"\%$")
plt.plot(t,fitted3,zorder=3,label="$N_{MAX}="+str(int(max_infected3))+"\pm"+str(round(error3/max_infected3*100,1))+"\%$")
